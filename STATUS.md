...
1. Continue the national jurisdiction intelligence/on-demand research architecture: implement contradiction handling, research/migrate legacy fields, then add coverage/on-demand workflows and Volusia as one canonical proof case.
