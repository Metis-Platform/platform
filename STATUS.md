...
1. Continue the national jurisdiction intelligence/on-demand research architecture: add source-authority verification operations and review UI, snapshot archival plus freshness/contradiction handling, researched legacy migration, then coverage/on-demand workflows and Volusia as one canonical proof case.
