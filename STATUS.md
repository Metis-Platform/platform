...
| FEMA county declaration context (#494) | In progress: preliminary research now retrieves a short, exact-FIPS OpenFEMA declaration summary nationwide with source provenance and explicit county-level limitations. |
