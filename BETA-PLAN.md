...
- [x] **#131** jurisdiction data program — plan agreed: comprehensive data dictionary, AI extraction pipeline, 3,141-county coverage; 8 implementation issues filed (#219–#226)
