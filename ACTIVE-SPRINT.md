...
- [ ] **Founding parcel acceptance repair (#291)** — obtain/record the authoritative county determination and make Volusia altkey 2340282 deterministic and truthful; dimensions + exceptions + provenance + setbacks + Florida data + MAO alignment. #355 adds the canonical provenance-labeled regression fixture with the honest conditional outcome; #351 carries APN/jurisdiction into a deal but does not promote research facts into authoritative property records; #356 aligns raw-land MAO with the documented rural/infill bands and refuses to choose a band without investor input; #358 calculates and exposes the setback-constrained envelope and blocks a zero-envelope build exit.
