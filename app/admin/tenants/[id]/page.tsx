...
const ACTION_ICON: Record<string, string> = {
  ...
  BUYER_PROFILE_CREATED: '🏷️',
  BUYER_PROFILE_UPDATED: '🏷️',
  BUYER_LINKED_TO_DEAL: '🔗',
  BUYER_UNLINKED_FROM_DEAL: '🔗',
...
const ACTION_LABEL: Record<string, string> = {
  ...
  LAND_NOTE_CREATED: 'Land note created',
  CHECKLIST_CREATED: 'Checklist created',
  TASK_CREATED: 'Task created',
  TASK_UPDATED: 'Task updated',
  TASK_DELETED: 'Task deleted',
  TASK_COMMENT_CREATED: 'Task comment added',
  BUYER_PROFILE_CREATED: 'Buyer profile created',
  BUYER_PROFILE_UPDATED: 'Buyer profile updated',
  BUYER_LINKED_TO_DEAL: 'Buyer linked to deal',
  BUYER_UNLINKED_FROM_DEAL: 'Buyer unlinked from deal',
