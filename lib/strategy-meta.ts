...
const ALL: StrategyMeta[] = [
  ...
  },
  {
    ...
    newSubtitle: 'Track a fix & flip — purchase, rehab timeline, contractor, ARV, and projected returns.',
  ...
  },
  {
    ...
    newSubtitle: 'Add a wholesale lead — just a property and lead source to start. Add contract, deadlines, and buyer info as the deal progresses.',
  ...
  },
  {
    ...
    newSubtitle: 'Track a rental property — tenant, lease dates, rental strategy, and gross yield.',
  ...
  },
  {
    ...
    newSubtitle: 'Track a raw land parcel — option tracking, DD checklist, and option expiry deadline.',
